...
/* Sidebar */
.css-1d391kg { background-color: #1f2937; color: #ffffff; }
.css-1d391kg h2 { color: #ffffff; }
...
div.stButton > button:hover { background-color: #6366f1; }
...
st.sidebar.markdown("---")
st.sidebar.markdown("## 📥 Add PDF to Knowledge Base")
uploaded_file = st.sidebar.file_uploader("Choose a PDF file", type="pdf")
if uploaded_file and st.sidebar.button("Add PDF to Knowledge Base"):
    with st.spinner("📂 Updating knowledge base..."):
        update_knowledge_base(uploaded_file, chunk_method=chunk_method)
        st.success("✅ PDF added and knowledge base updated!")
